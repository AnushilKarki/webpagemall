...
//let only exact seller to read 
    ...
    public function read(User $user, Liability $liability)
    {
        if(empty($liability->shop)){
            return false;
        }
        return $user->id==$liability->shop->user_id;
    }
    
    public function edit(User $user, Liability $liability)
    {
        if (empty($liability->shop)) {
            return false;
        }
